    ...
    (function () {
      function SimpleBar(element, options) {
        ...
        this.drag = function (e) {
          ...
          _this.contentEl[_this.axis[_this.draggedAxis].scrollOffsetAttr] =
            scrollPos;
        };
        ...
        [
          ...
          },
          {
            ...
            value: function recalculate() {
              ...
              this.axis.y.track.rect =
                this.axis.y.track.el.getBoundingClientRect(); // Set isOverflowing to false if scrollbar is not necessary (content is shorter than offset)
          ...
          },
          {
            ...
            value: function positionScrollbar() {
              ...
              var scrollOffset =
                this.contentEl[this.axis[axis].scrollOffsetAttr];
              scrollOffset =
                axis === "x" &&
                this.isRtl &&
          ...
          },
          {
            ...
            value: function initHtmlApi() {
              this.initDOMLoadedElements =
                this.initDOMLoadedElements.bind(this); // MutationObserver is IE11+
